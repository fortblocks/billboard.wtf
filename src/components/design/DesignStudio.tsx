    ...
    <div className="relative h-full w-full overflow-hidden bg-neutral-950">
      <div className="absolute inset-0 flex items-end justify-center">
        <div className="relative" style={{ width: BOARD_WIDTH, transform: `translateY(${BOARD_OFFSET_Y}px)` }}>
          ...
          <div ref={faceRef} className="absolute overflow-hidden bg-white" style={{ left: FACE.left, top: FACE.top, right: FACE.right, bottom: FACE.bottom }} onClick={() => { setSelectedId(null); setPlusOpen(false); setFontPanelOpen(false); }} onPointerMove={onPointerMove} onPointerUp={onPointerUp} onPointerLeave={onPointerUp}>
