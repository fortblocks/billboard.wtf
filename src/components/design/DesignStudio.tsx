...
function welcome(): TextLayer[] {
  return [
    ...
    },
    {
      id: uid(),
      type: "text",
      text: "Everything you place here becomes the live poster. Text, image, stickers — make it unforgettable.",
      x: 12,
      y: 44,
      w: 76,
      h: 18,
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-neutral-950">
      <div className="absolute inset-0 flex items-end justify-center">
        ...
        >
          <div
            className="absolute left-0 right-0 z-30 flex items-center gap-2 px-1"
